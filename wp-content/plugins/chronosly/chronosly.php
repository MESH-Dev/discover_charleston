...
define('CHRONOSLY_ADDONS_URL', plugin_dir_url(__FILE__)."/addons"); //path para incluir scripts o css
define('CHRONOSLY_TEMPLATES_URL',  plugin_dir_url(__FILE__)."/custom-templates"); //path para incluir scripts o css
...
if (!class_exists('Chronosly')) {
    ...
    class Chronosly
    {
        ...
        public static function activate()
        {
            ...
            set_transient( '_chronosly_welcome', "1" );
            wp_schedule_event( time(), "daily", 'chronosly_update_core' );
        ...
        public static function deactivate()
        {
            ...
            wp_clear_scheduled_hook( 'chronosly_update_core' );
...
/*TODO todo lo de abajo


    - revisar els addons updates i sobretot els templates que s'han d'actualitzar.(al 2.0 els updates funcionen per wp!!)
    - repasar url rewrite en un cliente que no le funcionaba

    - permisos de update por addon, controlar que se trata del addon que quiere hacer update ya que si no con 1 sola licencia vale todo
    - BD ontador de dominios usando licencias de addons y plugins
    - arreglar el share box que no va en la lite


    2.1 - Templates posibles en html
    - ical i google a social media share

    PRO
    2.2 - revisar clonacio de templates i drag an drop

    ...
    <form id="settings" method="post" action="">
      ...
      <div id="tabs-1">
        <h2><?php _e("General settings", "chronosly");?></h2>
         <label> <?php _e("Backend profile", "chronosly")?></label>
            <select name="chronosly_tipo_perfil" id="chronosly_tipo_perfil">
                <option <?php if($vars['chronosly_tipo_perfil'] == "1") echo "selected='selected'"?> value="1"><?php _e("Basic", "chronosly")?></option>
                <option <?php if($vars['chronosly_tipo_perfil'] == "2") echo "selected='selected'"?> value="2"><?php _e("Pro", "chronosly")?></option>
            </select><span class="info"></span>
          <div class="info-hide">
              <?php echo __("Choose the profile that better suits your skills", "chronosly")."<br/><br/><b>".__("Basic", "chronosly")."</b><br/>".__("Don't worry about anything, just upload your events very easily. Templates and extra addons are available in our marketplace.", "chronosly");
              echo "<br/><br/><b>".__("Advanced", "chronosly")."</b><br/>".__("Take control of everything, make your own templates or edit the predefined ones with our editing drag &drop system.", "chronosly");?><br/>
          </div><br/>

// console.log(translated.bubble_create_js_code);
// console.log(translated.bubble_modify_js_code);
// console.log(translated.field_create_js_code);
// console.log(translated.field_modify_js_code);

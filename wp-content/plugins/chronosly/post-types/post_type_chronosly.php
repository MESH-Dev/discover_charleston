    ...
    class Post_Type_Chronosly
    {
       ...
       //EN principio no se utiliza pues tenemos el element position
        public static  function add_custom_orderby( $orderby ) {
            ...
            if((!isset($settings["chronosly_show_past_events"]) or !$settings["chronosly_show_past_events"]) and (!$_REQUEST["ch_from"] or !$_REQUEST["ch_to"])) {
            ...
            else if($settings["chronosly_featured_first"] and !$pastformat and !$_REQUEST["featured"]){
...
//                    else $pos += 10000000;
     ...
     public static function insert_og_in_head() {
        ...
        $settings = unserialize(get_option("chronosly-settings"));
         ...
         if( isset($settings["chronosly-base-templates-id"]) and $settings["chronosly-base-templates-id"] != 0 and !$_REQUEST["js_render"]){
...
// otherwise all custom meta fields are cleared out
        ...
        public function inicia_scripts(){
            ...
            if(is_array($ch_bubble_create_js_code) and count($ch_bubble_create_js_code)) wp_enqueue_script('chronosly-admin-elements');
            ...
            wp_register_script( 'chronosly-admin-wysihtml5', CHRONOSLY_URL.'/js/cleditor/jquery.cleditor.js', array( 'jquery' ));
   ...
   */
        ...
        function modify_admin_table( $column ) {
            ...
            $column['ch_organizer'] = __('Organizer', "chronosly");
            $column['ch_place'] = __('Place', "chronosly");
        ...
        public function add_meta_boxes()
        {
            ...
            //Add organizers
            if( $this->settings["chronosly_organizers"]){
        ...
        public function add_inner_meta_boxes($post, $metabox)
        {
            ...
            if (count($metabox['args']) and isset($metabox['args']['type'])) {
                ...
                if ('organizers' == $metabox['args']['type']) {
                ...
                } elseif ('places' == $metabox['args']['type']) {
